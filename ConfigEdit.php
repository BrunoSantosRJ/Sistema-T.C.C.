...
<div style="text-align:center; margin-top:2%;padding:5%;">
<h2 style="margin: 3% 0;">Deseja Alterar esses dados?</h2>

<a href="EditarProduto.php/?id=<?php echo $id ?>&nome=<?php echo $nome ?>&cat=<?php echo $cat ?>" style="margin:0 2%" class="btn btn-primary btn-lg">Sim</a>
<a class="btn btn-danger btn-lg" style="margin:0 2%" href="javascript:history.back()">Não</a>
